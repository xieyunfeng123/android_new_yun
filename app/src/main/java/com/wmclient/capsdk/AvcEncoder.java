...
{  
    ...
    public AvcEncoder(int width, int height, int framerate, int bitrate) throws IOException {
        ...
        vformat.setInteger(MediaFormat.KEY_BIT_RATE, width*height);
    ...
    {     
        try {    
            ...
            {  
                ...
                int pos = 0;  
                if(m_info != null && bufferInfo.flags == 1)  
                {                 
                ...
                else if (bKeyCome && bufferInfo.flags == 0) {
