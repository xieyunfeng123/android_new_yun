...
public class DepartmentCheckedActivity extends BaseActivity {
...
//                    }
        ...
        /*topNameAdapter.setOnNameClick(new TopNameAdaper.OnNameClick() {
            @Override
        ...
        switch (view.getId()) {
            case R.id.tv_sure:
                if (isManager == 0) {
                    ...
                    EventBus.getDefault().postSticky(new AddOrDeleteEvent(-1, list, 0));
//                    EventBus.getDefault().postSticky(new CreateGroupManagerEvent(accountList));
                }
                EventBus.getDefault().post(new FinishEvent("SelectDepartmentActivity"));
                finish();
                break;
            case R.id.tv_back:
                finish();
