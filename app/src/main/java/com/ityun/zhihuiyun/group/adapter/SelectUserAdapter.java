...
public class SelectUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (position == 0) {
            ...
            editText=topHolder.item_search;
            ...
            itemUserHolder.item_user_name.setText(mlist.get(position - 1).getAccountName());
            ...
            itemUserHolder.item_user_img.settText(mlist.get(position - 1).getAccountName());
