...
public class RobTalkActivity extends BaseActivity implements View.OnTouchListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (groupInfo != null) {
            ...
            members.add(member);
            GroupChatUtil.getInstance().invitationChat(groupInfo.getId(), members, 8, new GroupChatUtil.JoinChatListener() {
                @Override
            ...
            if (receive.isJoin()) {
                ...
                GroupChatUtil.getInstance().joinGroupTalk(8, chatRoomId, new GroupChatUtil.JoinChatListener() {
                    @Override
                    public void ChatSucess(int chatId, List<Member> memberList) {
                ...
                rob_state_ll.setVisibility(View.INVISIBLE);
                request_call_ll.setVisibility(View.VISIBLE);
            }
    ...
    public void viewOnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.group_accept:
                ...
                request_call_ll.setVisibility(View.INVISIBLE);
                if (receive != null) {
                    GroupChatUtil.getInstance().agreeChat(chatRoomId, receive.getSponsorid(), 8, new GroupChatUtil.JoinChatListener() {
                        @Override
                        public void ChatSucess(int chatId, List<Member> memberList) {
                            members.clear();
                            members.addAll(memberList);
